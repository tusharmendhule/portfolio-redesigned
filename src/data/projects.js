const projects = [
  {
    ...
    category: "Full Stack",
    status: "In Progress",
    highlights: ["JWT authentication", "REST API", "Responsive design", "Payment ready"],
  },
  {
    ...
    category: "Full Stack",
    status: "Completed",
    highlights: ["Drag-and-drop", "Real-time sync", "Team boards", "Dark mode"],
  },
  {
  ...
  },
  {
    ...
    category: "Backend",
    status: "Completed",
    highlights: ["CRUD operations", "Auth middleware", "File uploads", "Pagination"],
  },
];
